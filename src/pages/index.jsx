...
const subjects = [
    {
      title: 'Tally Prime',
      desc: 'Master accounting with Tally Prime, GST, inventory, payroll, and BUSY software',
      icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 40">
          <path fillRule="evenodd" clipRule="evenodd" d="M6.30281 28.9536H8.45394C9.05625 28.9536 9.48648 29.5426 9.48648 30.2495V36.8465C9.48648 37.6711 9.05625 38.2602 8.45394 38.2602H6.30281C5.78654 38.2602 5.27026 37.6711 5.27026 36.8465V30.2495C5.27026 29.5426 5.78654 28.9536 6.30281 28.9536Z"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M13.7027 23.7833H15.8987C16.4257 23.7833 16.8649 24.4239 16.8649 25.3207V36.7228C16.8649 37.6196 16.4257 38.2602 15.8987 38.2602H13.7027C13.0879 38.2602 12.6487 37.6196 12.6487 36.7228V25.3207C12.6487 24.4239 13.0879 23.7833 13.7027 23.7833Z"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M21.0596 19.6471H23.2108C23.727 19.6471 24.2433 20.412 24.2433 21.1769V36.7303C24.2433 37.6227 23.727 38.2602 23.2108 38.2602H21.0596C20.4573 38.2602 20.0271 37.6227 20.0271 36.7303V21.1769C20.0271 20.412 20.4573 19.6471 21.0596 19.6471Z"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M28.4381 15.5109H30.5892C31.1055 15.5109 31.6217 16.1499 31.6217 17.0445V36.7265C31.6217 37.6212 31.1055 38.2602 30.5892 38.2602H28.4381C27.8357 38.2602 27.4055 37.6212 27.4055 36.7265V17.0445C27.4055 16.1499 27.8357 15.5109 28.4381 15.5109Z"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M26.9989 7.6293L23.05 18.137L20.3744 15.4678C15.622 19.6266 9.96272 22.5976 3.63238 24.2568C1.36694 24.9297 0.353173 21.6176 2.74495 21.0505C8.47735 19.533 13.5443 16.8156 17.8363 13.1279L15.5453 10.8879L26.9989 7.6293Z" fill="#FFB31F"/>
        </svg>
      ),
    ...
    },
    {
      ...
      desc: 'Learn essential computer skills including Office tools, Internet, Cyber Safety, and AI basics',
      icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49 39">
    ...
    },
    {
      ...
      desc: 'Build websites with HTML, CSS, JavaScript, and React.',
       icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    ...
    },
    {
      ...
      desc: 'Learn professional graphic design using industry-standard tools like Photoshop, Illustrator, and Canva.',
      icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49 46">
    ...
    {
      title: 'Advance Excel',
      desc: 'Learn the essentials of digital marketing including SEO, SEM, SMM, content, email marketing, and web analytics. Perfect for aspiring marketers.',
      icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 46">
    ...
    },
    {
      ...
      desc: 'Advanced Excel with MIS Syllabus.',
      icon: (
        <svg className="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
          ...
          <path d="M29.971 21.376L30.874 20.7971C30.917 20.5077 30.917 20.2183 30.917 19.8875C30.917 17.324 30.186 14.8846 28.896 12.8586L26.832 14.8433C27.649 16.3731 28.122 18.0683 28.122 19.8875C28.122 20.7558 27.993 21.5827 27.821 22.4096C28.552 22.2029 29.283 21.8721 29.971 21.376Z"/>
          ...
          <path d="M24.9831 22.7405C25.3271 21.8309 25.4991 20.8799 25.4991 19.8876C25.4991 18.7713 25.2841 17.6963 24.8541 16.704L22.5751 18.8953C22.6611 19.2261 22.6611 19.5569 22.6611 19.8876C22.6611 20.9213 22.4031 21.8722 21.8871 22.7405H24.9831Z"/>
          <path d="M36.0771 5.37505C35.9051 5.00293 35.5181 4.75486 35.0881 4.75486H32.2931V2.06736C32.2931 1.6539 32.0351 1.28178 31.6481 1.1164C31.2611 0.951011 30.7881 1.0337 30.4871 1.32313L27.6061 4.09332C27.3911 4.30005 27.3051 4.54813 27.3051 4.7962V7.60774L17.8021 16.7452C17.4151 16.5799 16.9851 16.4972 16.5121 16.4972C14.5771 16.4972 12.9861 18.027 12.9861 19.8875C12.986 21.7481 14.5771 23.2779 16.5121 23.2779C18.4471 23.2779 20.0381 21.7481 20.0381 19.8875C20.0381 19.4327 19.9521 19.0193 19.7801 18.6472L29.2831 9.50966H32.2071C32.5081 9.50966 32.7661 9.38562 32.9381 9.22024L35.8191 6.45005C36.1631 6.16063 36.2491 5.74716 36.0771 5.37505Z" fill="#FFB31F"/>
          ...
          <path d="M37.926 26.5029V21.1279C37.926 20.1769 36.808 19.6394 36.034 20.1769L35.088 20.8385V38.1212L36.034 38.7827C36.851 39.3202 37.926 38.7827 37.926 37.8317V32.4567C39.56 32.3327 40.85 31.051 40.85 29.4798C40.807 27.9087 39.517 26.6269 37.926 26.5029Z"/>
        </svg>
      ),
    },
  ];
  const teamMembers = [
  {
    ...
    image: 'img/team/team__1.png',
    social: [
      { href: '#', icon: 'icofont-facebook' },
      { href: '#', icon: 'icofont-twitter' },
      { href: '#', icon: 'icofont-instagram' },
      { href: '#', icon: 'icofont-youtube-play' },
    ],
  },
  {
    name: 'Daniel Rock',
    role: 'INTERIOR DESIGNER',
    image: 'img/team/team__2.png',
    social: [
      { href: '#', icon: 'icofont-facebook' },
      { href: '#', icon: 'icofont-twitter' },
      { href: '#', icon: 'icofont-instagram' },
  ...
  {/* ==================== HERO BANNER ==================== */}
<div className="herobannerarea herobannerarea__2 herobannerarea__online__course py-5">
  <div className="container">
    <div className="row align-items-center position-relative g-4">
      ...
      <div className="col-xl-7 col-lg-7 col-md-12 col-sm-12" data-aos="fade-up">
        <div className="herobannerarea__content__wraper text-center text-lg-start">
          
          {/* Title Section */}
          <div className="herobannerarea__title mb-3">
            <div className="herobannerarea__small__title mb-2">
              <span>Education Solution</span>
            </div>
            <div className="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
              <h2 className="fw-bold">
                Master Your <span> Skills </span> with <span>Max Education</span>
              </h2>
            </div>
          </div>

          {/* Text */}
          <div className="herobannerarea__text herobannerarea__text__2 mb-4">
            <p className="mb-0">
      ...
      <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up">
        <div className="herobanner__video registerarea__video position-relative text-center">
          <img
            loading="lazy"
          ...
          />
          <div className="video__pop__btn position-absolute top-50 start-50 translate-middle">
            <a
              className="video-btn d-inline-block"
        ...
        <div className="container">
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                ...
                <div className="section__title__2">
                    ...
                    <h2>Welcome to the Max Education</h2>
                    </div>
                </div>
                ...
                <div className="aboutarea__para aboutarea__para__2">
                    <p>
                    <strong>10+ Years of Experience in Computer Education & Skill Training</strong> -Our mission is to create a modern, results-driven learning environment where learners develop the confidence and expertise required to excel in today’s fast-paced job market. We combine <strong>theoretical understanding with hands-on projects</strong> to ensure that every student gains real-world experience and industry-ready capabilities.  </p>
                </div>
                ...
                <div className="aboutarea__list__2">
                    <ul>
                    <li>
                        <i className="icofont-check"></i> Explore a variety of fresh educational Courses
                    </li>
                    <li>
                        <i className="icofont-check"></i> Learn from expert instructors with real-world experience
                    </li>
                    <li>
                        <i className="icofont-check"></i> Get certified and boost your career instantly
                    </li>
                    </ul>
                </div>
        ...
        <div className="populerarea sp_top_80 sp_bottom_50">
          <div className="container">
            ...
            <div className="row populerarea__wraper">
              ...
              <div className="col-xl-5 col-lg-5 col-md-6 col-sm-6" data-aos="fade-up">
          ...
          {/* Subjects Grid - Card Layout */}
            <div className="row">
              {subjects.map((subject, index) => (
                <div key={index} className="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4" data-aos="fade-up">
                  <div className="card h-100 text-center shadow-sm border-0">
              
                    <div className="card-body">
                       <div className="mb-3 d-flex justify-content-center align-items-center">
                        <div className="subject-icon rounded-circle d-flex justify-content-center align-items-center" style={{ width: "70px", height: "70px" }}>
                          {subject.icon}
                        </div>
                      </div>
                      <h5 className="card-title mb-2">{subject.title}</h5>
                      <p className="card-text text-muted" style={{ minHeight: "60px" }}>{subject.desc}</p>
                    </div>
                  </div>
                </div>
              ))}
